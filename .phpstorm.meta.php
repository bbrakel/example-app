...
'debugbar.queries.explain','contacts.index','contacts.create','contacts.store',
'contacts.show','contacts.edit','contacts.update','contacts.destroy','dashboards.index',
'dashboards.create','dashboards.store','dashboards.show','dashboards.edit','dashboards.update',
'dashboards.destroy','invoices.index','invoices.create','invoices.store','invoices.show',
'invoices.edit','invoices.update','invoices.destroy','products.index','products.create',
'products.store','products.show','products.edit','products.update','products.destroy',
'services.index','services.create','services.store','services.show','services.edit',
'services.update','services.destroy','settings.index','settings.create','settings.store',
'settings.show','settings.edit','settings.update','settings.destroy','users.index',
...
'validation.attributes.amount','validation.attributes.date','validation.attributes.description','validation.attributes.due_at','validation.attributes.end_at',
'validation.attributes.idle_time','validation.attributes.invoice_id','validation.attributes.name','validation.attributes.paid_at','validation.attributes.price',
'validation.attributes.quantity','validation.attributes.sent_at','validation.attributes.serial','validation.attributes.service_id','validation.attributes.services',
'validation.attributes.start_at','validation.attributes.total','validation.attributes.user_id','validation.attributes.vat','validation.attributes.status',
'validation.actions.index','validation.actions.create','validation.actions.store','validation.actions.show','validation.actions.edit',
'validation.actions.update','validation.actions.destroy','validation.actions.approve','validation.actions.archive','validation.actions.cancel',
'validation.actions.publish','validation.actions.reject','validation.actions.restore','validation.actions.send','validation.actions.unpublish',
'validation.actions.download',);
